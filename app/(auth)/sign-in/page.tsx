  ...
  return (
    <>
      ...
      <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-zinc-50 dark:bg-zinc-950 font-sans">
        ...
        <div className="hidden lg:flex lg:col-span-5 relative overflow-hidden bg-zinc-950 border-r border-zinc-900 flex-col justify-between p-12 text-white">
          ...
          <div className="relative z-10 my-auto space-y-6">
            ...
            <p className="text-zinc-400 text-lg max-w-md font-light leading-relaxed">
              Experience the next generation of task management. Built with lightning-fast APIs and secure authentication.
            </p>

            {/* Micro Feature Bullet Points */}
            <div className="space-y-4 pt-6">
              {[
                { title: 'Neon Serverless DB', desc: 'Real-time scaling and low latency queries.' },
                { title: 'Google Auth Integrated', desc: 'Secure, single-click sign-in protocol.' },
                { title: 'Project Board View', desc: 'Intuitive tracking and state updates.' }
              ].map((feature, idx) => (
        ...
        <div className="lg:col-span-7 flex flex-col justify-center items-center px-6 py-12 md:px-12 relative overflow-hidden bg-white dark:bg-zinc-950">
          ...
          <div className="w-full max-w-md space-y-8 relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button 
                type="submit" 
                className="w-full py-2.5 bg-zinc-900 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-100 text-white dark:text-zinc-900 font-semibold rounded-lg shadow-lg hover:shadow-zinc-500/10 active:scale-[0.99] transition-all cursor-pointer flex justify-center items-center"
              >
                Sign In
              </Button>
